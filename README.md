...
✅ **Puntuación de repertorio**: métrica agregada (10 − media de fallos, sumada por pieza con al menos 5 días de práctica) en los resúmenes semanal/mensual/anual y por mes en el informe anual, para ver el progreso de un vistazo
✅ **Resúmenes semanal, mensual y anual**: pantalla previa a la primera sesión de cada semana, mes o año con tiempo/días practicados, puntuación y su variación, piezas destacadas, piezas nuevas y avisos de progresión pendientes
...
- Del mismo modo, antes de la primera sesión de cada mes y de cada año se muestra el **resumen mensual/anual** del periodo anterior, con un enlace a su informe mensual/anual (si coinciden varios, solo el más amplio)
